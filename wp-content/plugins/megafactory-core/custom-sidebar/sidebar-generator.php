...
class megafactory_sidebar_generator {
	...
	public function megafactory_sidebar_generator(){
	...
	public static function admin_page(){
		...
		<div class="wrap">
			<h2><?php esc_html_e( 'Sidebar Generator', 'megafactory-core' ); ?></h2>
			<p>
				<?php esc_html_e( 'The sidebar name is for your use only. It will not be visible to any of your visitors.', 'megafactory-core' ); ?> 
				<?php esc_html_e( 'A CSS class is assigned to each of your sidebar, use this styling to customize the sidebars.', 'megafactory-core' ); ?>
			</p>
			<br />
			...
			<table class="widefat page" id="sbg_table" style="width:600px;">
				<tr>
					<th><?php esc_html_e( 'Sidebar Name', 'megafactory-core' ); ?></th>
					<th><?php esc_html_e( 'CSS class', 'megafactory-core' ); ?></th>
					<th><?php esc_html_e( 'Remove', 'megafactory-core' ); ?></th>
				</tr>
				<?php
				$sidebars = megafactory_sidebar_generator::get_sidebars();
				if(is_array($sidebars) && !empty($sidebars)){
				...
				<?php
					...
					?>
					<tr>
						<td colspan="3"><?php esc_html_e( 'No Sidebars defined', 'megafactory-core' ); ?></td>
					</tr>
					<?php
				}
				?>
	...
	*/
	public static function get_sidebars(){
		$sidebar_json = get_option('megafactory_custom_sidebars');
