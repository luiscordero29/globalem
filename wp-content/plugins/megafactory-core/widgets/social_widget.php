<?php
add_action( 'widgets_init', 'megafactory_zozo_social_load_widget' );
function megafactory_zozo_social_load_widget() {
	register_widget( 'megafactory_zozo_social_widget' );
}
class megafactory_zozo_social_widget extends WP_Widget {
	/**
	 * Widget setup.
	 */
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'zozo_social_widget', 'description' => esc_html__('A widget that displays your social icons', 'megafactory-core') );
		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'zozo_social_widget' );
		/* Create the widget. */
		parent::__construct( 'zozo_social_widget', esc_html__('Megafactory Social Icons', 'megafactory-core'), $widget_ops, $control_ops );
	}
	/**
	...
	function widget( $args, $instance ) {
		...
		?>
			...
			<ul class="nav social-icons social-widget widget-content<?php echo esc_attr( $class_name ); ?>">
				...
				<?php if($googleplus) : ?><li><a href="<?php echo esc_url($googleplus); ?>" target="_blank" class="social-gplus"><i class="fa fa-google-plus"></i></a></li><?php endif; ?>
	...
	function form( $instance ) {
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id('socialstyle') ); ?>"><?php esc_html_e('Select Post Type:', 'megafactory-core'); ?></label> 
		<select id="<?php echo esc_attr( $this->get_field_id('socialstyle') ); ?>" name="<?php echo esc_attr( $this->get_field_name('socialstyle') ); ?>" class="widefat" style="width:100%;">
			<?php $social_style = array( "transparent" => esc_html__( 'Transparent', 'megafactory-core' ), "squared" => esc_html__( 'Squared', 'megafactory-core' ), "rounded" => esc_html__( 'Rounded', 'megafactory-core' ), "circled" => esc_html__( 'Circled', 'megafactory-core' ) ); ?>
		...
		<!-- Social Icons Fore. -->
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id('social_icons_fore') ); ?>"><?php esc_html_e('Social Icons Fore:', 'megafactory-core'); ?></label> 
		<select id="<?php echo esc_attr( $this->get_field_id('social_icons_fore') ); ?>" name="<?php echo esc_attr( $this->get_field_name('social_icons_fore') ); ?>" class="widefat" style="width:100%;">
			<?php $social_icons_fore = array( "black" => esc_html__( 'Black', 'megafactory-core' ), "white" => esc_html__( 'White', 'megafactory-core' ), "own" => esc_html__( 'Own Color', 'megafactory-core' ) ); ?>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id('social_icons_hfore') ); ?>"><?php esc_html_e('Social Icons Fore Hover:', 'megafactory-core'); ?></label> 
		<select id="<?php echo esc_attr( $this->get_field_id('social_icons_hfore') ); ?>" name="<?php echo esc_attr( $this->get_field_name('social_icons_hfore') ); ?>" class="widefat" style="width:100%;">
			<?php $social_icons_hfore = array( "h-black" => esc_html__( 'Black', 'megafactory-core' ), "h-white" => esc_html__( 'White', 'megafactory-core' ), "h-own" => esc_html__( 'Own Color', 'megafactory-core' ) ); ?>
		...
		<!-- Social Icons Bg. -->
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id('social_icons_bg') ); ?>"><?php esc_html_e('Social Icons Background:', 'megafactory-core'); ?></label> 
		<select id="<?php echo esc_attr( $this->get_field_id('social_icons_bg') ); ?>" name="<?php echo esc_attr( $this->get_field_name('social_icons_bg') ); ?>" class="widefat" style="width:100%;">
			<?php $social_icons_bg = array( "bg-transparent" => esc_html__( 'Transparent', 'megafactory-core' ), "bg-black" => esc_html__( 'Black', 'megafactory-core' ), "bg-white" => esc_html__( 'White', 'megafactory-core' ), "bg-light" => esc_html__( 'RGBA Light', 'megafactory-core' ), "bg-dark" => esc_html__( 'RGBA Dark', 'megafactory-core' ), "bg-own" => esc_html__( 'Own Color', 'megafactory-core' ) ); ?>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id('social_icons_hbg') ); ?>"><?php esc_html_e('Social Icons Background Hover:', 'megafactory-core'); ?></label> 
		<select id="<?php echo esc_attr( $this->get_field_id('social_icons_hbg') ); ?>" name="<?php echo esc_attr( $this->get_field_name('social_icons_hbg') ); ?>" class="widefat" style="width:100%;">
			<?php $social_icons_hbg = array( "hbg-transparent" => esc_html__( 'Transparent', 'megafactory-core' ), "hbg-black" => esc_html__( 'Black', 'megafactory-core' ), "hbg-white" => esc_html__( 'White', 'megafactory-core' ), "hbg-light" => esc_html__( 'RGBA Light', 'megafactory-core' ), "hbg-dark" => esc_html__( 'RGBA Dark', 'megafactory-core' ), "hbg-own" => esc_html__( 'Own Color', 'megafactory-core' ) ); ?>
		...
		<p><?php esc_html_e( 'Note: Set your social links in the Customizer', 'megafactory-core' ); ?></p>
		
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Show Facebook:', 'megafactory-core' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Show Twitter:', 'megafactory-core' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Show Instagram:', 'megafactory-core' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'pinterest' ) ); ?>"><?php esc_html_e( 'Show Pinterest:', 'megafactory-core' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'bloglovin' ) ); ?>"><?php esc_html_e( 'Show Bloglovin:', 'megafactory-core' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'googleplus' ) ); ?>"><?php esc_html_e( 'Show Google Plus:', 'megafactory-core' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'tumblr' ) ); ?>"><?php esc_html_e( 'Show Tumblr:', 'megafactory-core' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'youtube' ) ); ?>"><?php esc_html_e( 'Show Youtube:', 'megafactory-core' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Show Dribbble:', 'megafactory-core' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'soundcloud' ) ); ?>"><?php esc_html_e( 'Show Soundcloud:', 'megafactory-core' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'vimeo' ) ); ?>"><?php esc_html_e( 'Show Vimeo:', 'megafactory-core' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Show Linkedin:', 'megafactory-core' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'rss' ) ); ?>"><?php esc_html_e( 'Show RSS:', 'megafactory-core' ); ?></label>
