...
( function( $ ) {
	...
	$(document).on( 'click', '.button-uninstall-demo', function(e) {
		...
		$.confirm({
			theme: 'supervan',
			title: false,
			content: megafactory_admin_ajax_var.unins_confirm,
			confirmButtonClass: 'btn-success',
			cancelButtonClass: 'btn-danger',
			confirmButton: megafactory_admin_ajax_var.yes,
   			cancelButton: megafactory_admin_ajax_var.no,
			confirm: function(){
				...
				progress_text.text(megafactory_admin_ajax_var.uninstalling);
				loading_wrap.show();
				...
				$.ajax({
					...
					success: function(response){
						if( response && response.indexOf('success') == -1 ) {
							...
							loading_wrap.hide();
							progress_text.text(megafactory_admin_ajax_var.uninstalled);
						}
					},
					error: function(response, errorThrown){
						loading_wrap.hide();
						alert(megafactory_admin_ajax_var.unins_pbm);
					}
				});
			}
		});
			...
			$(document).on( 'click', '.button-install-demo', function(e) {
				...
				if( choosed_demo !== null ) {
					...
					$.confirm({
						...
						confirmButtonClass: 'btn-success',
    					cancelButtonClass: 'btn-danger',
						confirmButton: megafactory_admin_ajax_var.proceed,
   						cancelButton: megafactory_admin_ajax_var.cancel,
						confirm: function(){
							loading_wrap.show();
							$(current).parents('.zozothemes-demo-item').find('.installation-progress p').text(megafactory_admin_ajax_var.downloading);
							...
							$.ajax({
								...
								success: function(response){
									...
									if( response && response.indexOf('success') == -1 ) {
										...
										progress_text.text(megafactory_admin_ajax_var.import_xml);
										...
										$.ajax({
											...
											success: function(response){
												if( response && response.indexOf('success') == -1 ) {
													...
													progress_text.text(megafactory_admin_ajax_var.import_sidebars);
													...
													$.ajax({
														...
														url: megafactory_admin_ajax_var.admin_ajax_url,
														data: {
															action: 'megafactory_custom_sidebars', 
														},
														success: function(response){
															if( response && response.indexOf('success') == -1 ) {
																alert(response);
																...
																progress_text.text(megafactory_admin_ajax_var.import_widg);
																...
																$.ajax({
																	...
																	success: function(response){
																		if( response && response.indexOf('success') == -1 ) {
																			...
																			progress_text.text(megafactory_admin_ajax_var.import_theme_opt);
																			...
																			$.ajax({
																				...
																				url: megafactory_admin_ajax_var.admin_ajax_url,
																				data: {
																					action: 'megafactory_theme_option',
																				},
																				success: function(response){
																					if( response && response.indexOf('success') == -1 ) {
																						alert(response);
																						...
																						if( revslider != '' && revslider != 0 ){
																							...
																							progress_text.text(megafactory_admin_ajax_var.import_revslider);
																							...
																							$.ajax({
																								...
																								success: function(response){
																									if( response && response.indexOf('success') == -1 ) {
																										...
																										progress_text.text(megafactory_admin_ajax_var.imported);
																										
																									}
																									loading_wrap.hide();
																								},
																								error: function(response, errorThrown){
																									alert(megafactory_admin_ajax_var.import_pbm);
																								}
								...
								error: function(response, errorThrown){
									alert(megafactory_admin_ajax_var.access_pbm);
								}
