...
class megafactory_wp_bootstrap_navwalker extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		if ( class_exists( 'Megafactory_Walker_Nav_Menu_Edit_Custom' ) ) {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( class_exists( 'Megafactory_Walker_Nav_Menu_Edit_Custom' ) ) {
			...
			if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
				...
				$hot_icon = '';
				if( $item->popbtn != '' && isset( $this->megafactory_options['menu-tag'] ) && $this->megafactory_options['menu-tag'] == 1 ){
					$tag_text = '';
					if( $this->megafactory_options['menu-tag-'.$item->popbtn.'-text'] != '' )
						$tag_text = esc_html( $this->megafactory_options['menu-tag-'.$item->popbtn.'-text'] );
				...
				if( $depth == 0 && $item->megamenulogo == 'on' ){
					...
					$item_output .= $ahe->megafactoryHeaderLogo();
	...
	public static function fallback( $args ) {
		if ( current_user_can( 'manage_options' ) ) {
			...
			$fb_output .= '>';
			$fb_output .= '<li><a href="' . admin_url( 'nav-menus.php' ) . '">'. esc_html__('Add a menu', 'megafactory') .'</a></li>';
			$fb_output .= '</ul>';
