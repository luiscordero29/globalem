...
if ( ! function_exists( "megafactory_vc_twitter_shortcode" ) ) {
	function megafactory_vc_twitter_shortcode( $atts, $content = NULL ) {
		
		$atts = vc_map_get_attributes( "megafactory_vc_twitter", $atts );
		extract( $atts );
		...
		// Get VC Animation
		$class_names .= megafactoryGetCSSAnimation( $animation );
		...
		if( class_exists( "MegafactoryRedux" ) ){
			$tweets = megafactory_get_tweets( $consumer_key, $consumer_secret, $access_token, $access_token_secret, $tweet_count, $twitter_id );
		}else{
			return false;
		}
					...
					foreach( $tweets as $tweet ) {
						...
						if( $i < $tweet_count ){
							...
							$output .= '<li class="tweet-item">';
								...
								$time_ago = megafactory_tweet_time_ago( $tweet_time );
...
if ( ! function_exists( "megafactory_vc_twitter_shortcode_map" ) ) {
	function megafactory_vc_twitter_shortcode_map() {
				
		vc_map( 
			array(
				"name"					=> esc_html__( "Twitter", "megafactory" ),
				"description"			=> esc_html__( "Recent tweets.", "megafactory" ),
				"base"					=> "megafactory_vc_twitter",
				...
				"params"				=> array(
					...
					array(
						"type"			=> "img_select",
						"heading"		=> esc_html__( "Twitter Layout", "megafactory" ),
						"param_name"	=> "twitter_layout",
						"img_lists" => array ( 
							"1"	=> MEGAFACTORY_ADMIN_URL . "/assets/images/twitter/1.png",
							"2"	=> MEGAFACTORY_ADMIN_URL . "/assets/images/twitter/2.png",
							"3"	=> MEGAFACTORY_ADMIN_URL . "/assets/images/twitter/3.png"
						),
						"default"		=> "1",
						"group"			=> esc_html__( "Layouts", "megafactory" )
					),
					array(
						"type"			=> "dropdown",
						"heading"		=> esc_html__( "Twitter Variation", "megafactory" ),
						"description"	=> esc_html__( "This is option for twitter variatoin either dark or light.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for twitter text align", "megafactory" ),
					...
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Twitter ID", "megafactory" ),
						"param_name"	=> "twitter_id",
						"value" 		=> "",
						"group"			=> esc_html__( "API", "megafactory" )
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Consumer Key", "megafactory" ),
					...
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Consumer Secret", "megafactory" ),
					...
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Access Token", "megafactory" ),
					...
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Access Token Secret", "megafactory" ),
					...
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Tweet Count", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for twitter slider option.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for twitter slide items shown on large devices.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for twitter slide items shown on tab.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for twitter slide items shown on mobile.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for twitter slider auto play.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for twitter slider loop.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for twitter slider center, for this option must active loop and minimum items 2.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for twitter slider navigation.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for twitter slider pagination.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for twitter slider margin space.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for twitter slider duration.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for twitter slider smart speed.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for twitter slider scroll by.", "megafactory" ),
...
add_action( "vc_before_init", "megafactory_vc_twitter_shortcode_map" );