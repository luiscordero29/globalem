<?php 
/**
 * Megafactory Portfolio
 */

if ( ! function_exists( "megafactory_vc_portfolio_shortcode" ) ) {
	function megafactory_vc_portfolio_shortcode( $atts, $content = NULL ) {
		
		$atts = vc_map_get_attributes( "megafactory_vc_portfolio", $atts );
		extract( $atts );
		...
		$portfolio_items = isset( $portfolio_items ) ? megafactory_drag_and_drop_trim( $portfolio_items ) : array( 'Enabled' => '' );
		
		$overlay_items = $overlay_class = '';		
		if( isset( $portfolio_overlay_opt ) && $portfolio_overlay_opt == 'enable' ){
			$overlay_items = isset( $overlay_portfolio_items ) ? megafactory_drag_and_drop_trim( $overlay_portfolio_items ) : array( 'Enabled' => '' );
		...
		if( isset( $slide_opt ) && $slide_opt == 'on' ){
											...
											$output .= '<div class="portfolio-overlay'. esc_attr( $overlay_class ) .'">';
												if( isset( $overlay_items['Enabled'] ) ) :
													foreach( $overlay_items['Enabled'] as $element => $value ){
														$output .= megafactory_portfolio_shortcode_elements( $element, $portfolio_array );
													}
												endif;
											$output .= '</div><!-- .portfolio-overlay -->';
										}
										$output .= megafactory_portfolio_shortcode_elements( 'thumb', $thumb_array );
									$output .= '</div>';
			...
			if ( $query->have_posts() ) {
				...
				while ( $query->have_posts() ) : $query->the_post();
					...
					$inner_class .= $animate_load ? ' megafactory-animate' : '';
...
function megafactory_portfolio_shortcode_elements( $element, $opts = array() ){
	$output = '';
	switch( $element ){
		case "title":
			$custom_url = get_post_meta( get_the_ID(), 'megafactory_portfolio_custom_url', true );
			$target = get_post_meta( get_the_ID(), 'megafactory_portfolio_custom_url_target', true );
				...
				$output .= $opts['event'] == 'popup' ? '<a href="'. esc_url( wp_get_attachment_url( get_post_thumbnail_id() ) ) .'" class="image-gallery-link">' : '<a href="'. esc_url( $title_url ) .'" target="'. esc_attr( $target ) .'">';
					if( isset( $opts['thumb_size'] ) && is_array( $opts['thumb_size'] ) ){
						...
						if( $cropped_img ){
							...
							$output .= '<img class="img-fluid cpt-img" src="'. esc_url( $cropped_img[0] ) .'" width="'. esc_attr( $cropped_img[1] ) .'" height="'. esc_attr( $cropped_img[2] ) .'" alt="'. esc_html( $image_alt ) .'" />';
						}else{
...
if ( ! function_exists( "megafactory_vc_portfolio_shortcode_map" ) ) {
	function megafactory_vc_portfolio_shortcode_map() {
				
		vc_map( 
			array(
				"name"					=> esc_html__( "Portfolio", "megafactory" ),
				"description"			=> esc_html__( "Portfolio custom post type.", "megafactory" ),
				"base"					=> "megafactory_vc_portfolio",
				...
				"params"				=> array(
					...
					array(
						...
						"description"	=> esc_html__( "This is option for pagination show or hide.", "megafactory" ),
						"param_name"	=> "pagination",
						"value"			=> "off"
					),
					array(
						"type"			=> "switch_bit",
						"heading"		=> esc_html__( "Infinite Load", "megafactory" ),
						"description"	=> esc_html__( "This is option for portfolio infinite load.", "megafactory" ),
						"param_name"	=> "infinite",
						"value"			=> "off"
					),
					array(
						"type"			=> "switch_bit",
						"heading"		=> esc_html__( "Animate Load", "megafactory" ),
						"description"	=> esc_html__( "This is option for portfolio articles animate load.", "megafactory" ),
						"param_name"	=> "animate_load",
						"value"			=> "off"
					),
					array(
						"type"			=> "img_select",
						"heading"		=> esc_html__( "Portfolio Layout", "megafactory" ),
						"description"	=> esc_html__( "Choose portfolio layout normal grid( images or must be equal size ), fit row grid, masonry or list.", "megafactory" ),
						"param_name"	=> "portfolio_layout",
						"img_lists" => array ( 
							"1"	=> MEGAFACTORY_ADMIN_URL . "/assets/images/portfolio-layouts/grid.png",
							"2"	=> MEGAFACTORY_ADMIN_URL . "/assets/images/portfolio-layouts/fitrow.png",
							"3"	=> MEGAFACTORY_ADMIN_URL . "/assets/images/portfolio-layouts/masonry.png"
						),
						"default"		=> "1",
					...
					array(
						"type"			=> "img_select",
						"heading"		=> esc_html__( "Choose Filter Layout", "megafactory" ),
						"param_name"	=> "filter_layout",
						"img_lists" => array ( 
							"1"	=> MEGAFACTORY_ADMIN_URL . "/assets/images/1.jpg",
							"2"	=> MEGAFACTORY_ADMIN_URL . "/assets/images/2.jpg",
							"3"	=> MEGAFACTORY_ADMIN_URL . "/assets/images/3.jpg"
						),
						"default"		=> "2",
						"group"			=> esc_html__( "Layouts", "megafactory" )
					),
					array(
						"type"			=> "dropdown",
						"heading"		=> esc_html__( "Filter Align", "megafactory" ),
						"param_name"	=> "filter_align",
						"description"	=> esc_html__( "This is option for filter alignment style.", "megafactory" ),
						"value"			=> array(
					...
					array(
						"type"			=> "dropdown",
						"heading"		=> esc_html__( "Grid Columns", "megafactory" ),
						"description"	=> esc_html__( "How many grid columns to show. Example 3", "megafactory" ),
						"param_name"	=> "grid_cols",
						"value"			=> array(
							esc_html__( "2 Columns", "megafactory" )	=> "2",
							esc_html__( "3 Columns", "megafactory" )	=> "3",
							esc_html__( "4 Columns", "megafactory" )	=> "4"
						),
						"group"			=> esc_html__( "Layouts", "megafactory" )
					),
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Gutter Size", "megafactory" ),
						"description"	=> esc_html__( "This is setting for grid column inter spacing. Example 20", "megafactory" ),
					...
					array(
						"type"			=> "textfield",
						"heading"		=> esc_html__( "Filter All", "megafactory" ),
						"description"	=> esc_html__( "If need filter all tab, just fill the text box needed text to show instead of All text. If you leave this box blank, then all tab will disappear.", "megafactory" ),
					...
					array(
						"type"			=> "dropdown",
						"heading"		=> esc_html__( "Article Align", "megafactory" ),
						"param_name"	=> "article_align",
						"description"	=> esc_html__( "This is option for article alignment style.", "megafactory" ),
						"value"			=> array(
							esc_html__( "Default", "megafactory" )	=> "default",
							esc_html__( "Left", "megafactory" )		=> "left",
							esc_html__( "Center", "megafactory" )	=> "center",
						...
						"group"			=> esc_html__( "Article", "megafactory" )
					),
					array(
						"type"			=> "dropdown",
						"heading"		=> esc_html__( "Article Style", "megafactory" ),
						"param_name"	=> "article_style",
						"description"	=> esc_html__( "This is option for article style. Different article template.", "megafactory" ),
						"value"			=> array(
							esc_html__( "Default", "megafactory" )	=> "default",
							esc_html__( "Classic", "megafactory" )	=> "classic",
							esc_html__( "Creative", "megafactory" )	=> "creative",
							esc_html__( "Minimal", "megafactory" )	=> "minimal",
							esc_html__( "Angle", "megafactory" )	=> "angle"						
						),
						"group"			=> esc_html__( "Article", "megafactory" )
					),
					array(
						"type"			=> "dropdown",
						"heading"		=> esc_html__( "Image Click Event", "megafactory" ),
						"param_name"	=> "image_event",
						"description"	=> esc_html__( "This is option for pop up image or redirect to sigle portfolio.", "megafactory" ),
						"value"			=> array(
							esc_html__( "Pop Up", "megafactory" )	=> "popup",
							esc_html__( "Single Portfolio", "megafactory" )	=> "single"				
						),
						"group"			=> esc_html__( "Article", "megafactory" )
					),
					array(
						"type"			=> "switch_bit",
						"heading"		=> esc_html__( "Filter Hide/Show", "megafactory" ),
						"description"	=> esc_html__( "This is option for show or hide filter.", "megafactory" ),
					...
					array(
						"type"			=> "switch_bit",
						"heading"		=> esc_html__( "Zoom Icon", "megafactory" ),
						"description"	=> esc_html__( "This is option for show or hide zoom icon to your choosed layout.", "megafactory" ),
					...
					array(
						"type"			=> "switch_bit",
						"heading"		=> esc_html__( "External Link Icon", "megafactory" ),
						"description"	=> esc_html__( "This is option for show or hide zoom icon to your choosed layout.", "megafactory" ),
					...
					array(
						'type'			=> 'drag_drop',
						'heading'		=> esc_html__( 'Portfolio Items', 'megafactory' ),
						"description"	=> esc_html__( "This is settings for portfolio custom layout. here you can set your own layout. Drag and drop needed portfolio items to Enabled part.", "megafactory" ),
						...
						'dd_fields' => array ( 
							...
							'disabled' => array(
								'icons'	=> esc_html__( 'Icons', 'megafactory' )
							)
						),
						"group"			=> esc_html__( "Article", "megafactory" )
					),
					array(
						"type"			=> "dropdown",
						"heading"		=> esc_html__( "Overlay Portfolio Option", "megafactory" ),
						"description"	=> esc_html__( "This is option for enable overlay portfolio option.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for portfolio text align", "megafactory" ),
					...
					array(
						'type'			=> 'drag_drop',
						'heading'		=> esc_html__( 'Overlay Portfolio Items', 'megafactory' ),
						"description"	=> esc_html__( "This is settings for portfolio custom layout. here you can set your own layout. Drag and drop needed portfolio items to Enabled part.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "Here you can choose font color.", "megafactory" ),
						"param_name"	=> "font_color",
						"group"			=> esc_html__( "Color Settings", "megafactory" )
					),
					array(
						"type"			=> "colorpicker",
						"heading"		=> esc_html__( "Link Color", "megafactory" ),
						"description"	=> esc_html__( "Here you can choose link color.", "megafactory" ),
						"param_name"	=> "link_color",
						"group"			=> esc_html__( "Color Settings", "megafactory" )
					),
					array(
						"type"			=> "colorpicker",
						"heading"		=> esc_html__( "Link Hover Color", "megafactory" ),
						"description"	=> esc_html__( "Here you can choose link hover color.", "megafactory" ),
						"param_name"	=> "link_hcolor",
						"group"			=> esc_html__( "Color Settings", "megafactory" )
					), 
					array(
						"type"			=> "dropdown",
						"heading"		=> esc_html__( "Slide Image Layout", "megafactory" ),
						"param_name"	=> "slide_img_layout",
						"description"	=> esc_html__( "This is option for slide image layout either vertical or noraml.", "megafactory" ),
						"value"			=> array(
							esc_html__( "Normal", "megafactory" )	=> "normal",
							esc_html__( "Vertical", "megafactory" )	=> "vertical"
						),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for portfolio slider option.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for portfolio slide items shown on large devices.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for portfolio slide items shown on tab.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for portfolio slide items shown on mobile.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for portfolio slider auto play.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for portfolio slider loop.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for portfolio slider center, for this option must active loop and minimum items 2.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for portfolio slider navigation.", "megafactory" ),
					...
					array(
						"type"			=> "switch_bit",
						"heading"		=> esc_html__( "Pagination", "megafactory" ),
						"description"	=> esc_html__( "This is option for portfolio slider pagination.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for portfolio slider margin space. Example 10", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for portfolio slider duration. Example 5000", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for portfolio slider smart speed. Example 500", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for portfolio slider scroll by. Example 500", "megafactory" ),
...
add_action( "vc_before_init", "megafactory_vc_portfolio_shortcode_map" );