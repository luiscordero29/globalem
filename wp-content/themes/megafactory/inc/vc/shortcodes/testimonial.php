<?php 
/**
 * Megafactory Testimonial
 */

if ( ! function_exists( "megafactory_vc_testimonial_shortcode" ) ) {
	function megafactory_vc_testimonial_shortcode( $atts, $content = NULL ) {
		
		$atts = vc_map_get_attributes( "megafactory_vc_testimonial", $atts );
		extract( $atts );
				...
				$output .= '<div class="row">';
					...
					while ( $query->have_posts() ) : $query->the_post();
						...
						$output .= '<div class="'. esc_attr( $col_class ) .'">';
							...
							$elemetns = isset( $testimonial_items ) ? megafactory_drag_and_drop_trim( $testimonial_items ) : array( 'Enabled' => '' );

							if( isset( $elemetns['Enabled'] ) ) :
								foreach( $elemetns['Enabled'] as $element => $value ){
									$output .= megafactory_testimonial_shortcode_elements( $element, $testimoanil_array );
								}
							endif;
...
function megafactory_testimonial_shortcode_elements( $element, $opts = array() ){
	$output = '';
	switch( $element ){
		...
		case "designation":
			$designation = get_post_meta( $opts['post_id'], 'megafactory_testimonial_designation', true );
			if( $designation ) :
		...
		case "info":
			$output .= '<div class="testimonial-info">';
				$output .= '<p>';
					...
					$company_url = get_post_meta( $opts['post_id'], 'megafactory_testimonial_company_url', true );
					if( $company_url ) :
		...
		case "rate":
			$rate = get_post_meta( $opts['post_id'], 'megafactory_testimonial_rating', true );
			if( $rate ) :
				$output .= '<div class="testimonial-rating">';
					$output .= '<p>'. megafactory_star_rating( $rate ) .'</p>';
...
if ( ! function_exists( "megafactory_vc_testimonial_shortcode_map" ) ) {
	function megafactory_vc_testimonial_shortcode_map() {
				
		vc_map( 
			array(
				"name"					=> esc_html__( "Testimonial", "megafactory" ),
				"description"			=> esc_html__( "Testimonial custom post type.", "megafactory" ),
				"base"					=> "megafactory_vc_testimonial",
				...
				"params"				=> array(
					...
					array(
						"type"			=> "img_select",
						"heading"		=> esc_html__( "Testimonial Layout", "megafactory" ),
						"param_name"	=> "testimonial_layout",
						"img_lists" => array ( 
							"1"	=> MEGAFACTORY_ADMIN_URL . "/assets/images/testimonial/1.png",
							"2"	=> MEGAFACTORY_ADMIN_URL . "/assets/images/testimonial/2.png",
							"3"	=> MEGAFACTORY_ADMIN_URL . "/assets/images/testimonial/3.png"
						),
						"default"		=> "1",
						"group"			=> esc_html__( "Layouts", "megafactory" )
					),
					array(
						"type"			=> "dropdown",
						"heading"		=> esc_html__( "Testimonial Variation", "megafactory" ),
						"description"	=> esc_html__( "This is option for testimonial variatoin either dark or light.", "megafactory" ),
					...
					array(
						"type"			=> "dropdown",
						"heading"		=> esc_html__( "Testimonial Columns", "megafactory" ),
						"description"	=> esc_html__( "This is option for testimonial columns.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is settings for testimonial custom layout. here you can set your own layout. Drag and drop needed testimonial items to Enabled part.", "megafactory" ),
						...
						'dd_fields' => array ( 
							'Enabled' => array( 
								...
								'rate'	=> esc_html__( 'Star Rating', 'megafactory' ),
								'info'	=> esc_html__( 'Client Info', 'megafactory' ),
							),
							'disabled' => array(
					...
					array(
						...
						"description"	=> esc_html__( "This is option for testimonial text align", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for testimonial slider option.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for testimonial slide items shown on large devices.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for testimonial slide items shown on tab.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for testimonial slide items shown on mobile.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for testimonial slider auto play.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for testimonial slider loop.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for testimonial slider center, for this option must active loop and minimum items 2.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for testimonial slider navigation.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for testimonial slider pagination.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for testimonial slider margin space.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for testimonial slider duration.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for testimonial slider smart speed.", "megafactory" ),
					...
					array(
						...
						"description"	=> esc_html__( "This is option for testimonial slider scroll by.", "megafactory" ),
...
add_action( "vc_before_init", "megafactory_vc_testimonial_shortcode_map" );