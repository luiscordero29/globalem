...
(function( $ ) {
	...
	$( document ).ready(function() {
		...
		if( o_stat ){
			...
			$( '.megafactory-main-menu .menu-item > a[href^="#section-"], .megafactory-mobile-main-menu .menu-item > a[href^="#section-"]' ).on('click',function (e) {
				...
				if( $( ".secondary-menu-area" ) ){
					$( ".secondary-menu-area .secondary-space-toggle" ).trigger( "click" );
				}
		...
		/* Portfolio Animation */
		/*var anim_time = 300;
		$('.megafactory-animate').appear(function() {
			var elem = $(this);
			alert( elem.index() );
			setTimeout(function() {
				anim_time = 300;
		...
		var tot_anim_time;
		var last_app_ele = 0;
		$('.megafactory-animate').appear();
		$('.megafactory-animate').on('appear', function(event, $all_appeared_elements) {
