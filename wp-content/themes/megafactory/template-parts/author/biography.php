...
<div class="media author-info clearfix">
	...
	<div class="media-body author-meta">
		<div class="posts-count">
			...
			<?php else : ?>
				<h5><?php echo esc_html( $author_name );//esc_attr( $author_tot_posts ) . esc_html__(' Posts', 'megafactory'); ?></h5>
				<h6><?php echo esc_attr( $author_tot_posts ) . esc_html__(' Posts', 'megafactory'); ?></h6>
			<?php endif ; ?>
		</div>
